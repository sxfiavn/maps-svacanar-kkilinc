...
public class CachedJsonDataSource implements GeoJsonDataSource {
            ...
            .build(
                new CacheLoader<>() {
                  ...
                  public JsonData load(String key) {
                    String[] parts =
                        key.split("_");
                    return wrappedSource.searchFeaturesInBoundingBox(Double.parseDouble(parts[0]), Double.parseDouble(parts[1]),
  ...
  @Override
  public JsonData searchFeaturesInBoundingBox(double lowerX, double lowerY,
